...
/**
 * @Descriptions The class Page.java's implementation：与无关的分页参数及查询结果封装.
 *               注意所有序号从1开始.
 * @author scott
 * @date 2013-8-19 下午2:39:51
 * @version 1.0
 */
public class Page {
    ...
    public void setOrder(final String order) {
        ...
        for (String orderStr : orders) {
            if (!StringUtils.equals(DESC, orderStr)
                && !StringUtils.equals(ASC, orderStr)) throw new IllegalArgumentException(
                "排序方向" + orderStr + "不是合法值");
        }
