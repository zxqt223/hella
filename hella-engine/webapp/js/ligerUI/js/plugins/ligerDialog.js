...
(function ($)
{
    ...
    $.ligerDialog.alert = function (content, title, type, callback,wid,hei)
    {
        content = content || "";
      ...
      if(wid && hei){
        p = {
            content: content,width:wid,height:hei,
    ...
    $.ligerDialog.errorTab = function (content, title, onBtnClick,width,height)//add by lxb
    {
        return $.ligerDialog.alert(content, title, 'error', onBtnClick,width,height);
    };
